...
#read in data
dat = read.csv("Ex 2 Part 1.csv") #switch this out for the most recent file
...
#write.csv(combined, file = "Ex 2 Part 1 Processed.csv", row.names = FALSE) #change date on filename
